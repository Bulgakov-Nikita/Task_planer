...
/**
 * This is the model class for table "type_session".
 *
 * @property int $id Первичный ключ
 * @property string $name Тип сессии
 ...
 */
class TypeSession extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Session::className(), ['type_session_id' => 'id']);
    }
}
