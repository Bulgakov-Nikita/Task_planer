...
class m240521_201500_create_kvalification_table extends Migration{
    public function safeUp(){
        $this->createTable('kvalification',[
            ...
            'name' => $this->string(20)->notNull()->unique()->comment('название квалификация (бакалавр, магистратура, апирантура)'),
    ...
    public function safeDown(){
        ...
        $this->dropForeignKey('FK_c_kvalification_id', 'user');
        $this->dropForeignKey('FK_u_kvalification_id', 'user');
        $this->dropForeignKey('FK_d_kvalification_id', 'user');
    }
}
