...
class m240521_152300_create_sprav_dis_table extends Migration
{
    public function safeUp()
    {
        $this->createTable('sprav_dis', [
            ...
            'kafedra_id' => $this->date()->notNull()->comment('Ссылка на кафедру'),
    ...
    public function safeDown()
    {
        ...
        $this->dropForeigenKey('FK_kafedra_id_sprav_dis_id');
