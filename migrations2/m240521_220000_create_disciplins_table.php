...
class m240521_220000_create_disciplins_table extends Migration
{
    public function safeUp()
    {
        $this->createTable('disciplins', [
            ...
            'kafedra_id' => $this->integer()->comment('comment in light future'),
    ...
    public function safeDown()
    {
        ...
        $this->dropForeignKey('FK_comp_id321321', 'kafedra');
        $this->dropForeignKey('FK_c_disciplins_id', 'user');
        $this->dropForeignKey('FK_u_disciplins_id', 'user');
        $this->dropForeignKey('FK_d_disciplins_id', 'user');
    }
}