...
class m240521_210000_create_main_plan_table extends Migration{
    public function safeUp(){
        $this->createTable('main_plan',[
            ...
            'sprav_uch_god_id' => $this->integer()->notNull()->comment('id срока справ уч года'),
        ...
        $this->addForeignKey(
            'sprav_kafedra_id', 'main_plan', 'sprav_kafedra_id', 'sprav_kafedra', 'id'
        );
        $this->addForeignKey(
    ...
    public function safeDown(){
        ...
        $this->dropForeignKey('sprav_kafedra_id', 'sprav_kafedra');
