...
//        $this->parse_plan_table(); // 21
        $this->parse_disciplins_table(); // 22 добавить апдейт
        $this->parse_type_form_table(); // 23
//        $this->parse_form_table(); // 24 Добавить type_form_id и plan_id + добавить апдейт
        $this->parse_kaf_has_comp_table(); // 25 добавить апдейт
