...
class Paths {
    ...
    public static $path_to_ВыбранныеВидыРабот = 'return $this->xml->children("urn:schemas-microsoft-com:xml-diffgram-v1")->children()->dsMMISDB->ВыбранныеВидыРабот;';
    public static $path_to_ПланыКомпетенцииДисциплины = 'return $this->xml->children("urn:schemas-microsoft-com:xml-diffgram-v1")->children()->dsMMISDB->ПланыКомпетенцииДисциплины;';
    public static $path_to_ПланыНовыеЧасы = 'return $this->xml->children("urn:schemas-microsoft-com:xml-diffgram-v1")->children()->dsMMISDB->ПланыНовыеЧасы;';
