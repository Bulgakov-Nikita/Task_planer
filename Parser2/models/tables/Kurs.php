 ...
 * @property int $number_kurs Номер курса
...
class Kurs extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Calendary::className(), ['kurs_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Plan::className(), ['kurs_id' => 'id']);
    }
}
